...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4" style="font-family: 'Montserrat', sans-serif;">
    <!-- Error Alert -->
    @if ($errors->any())
    <div id="errorAlert" class="fixed top-4 right-4 max-w-xs bg-white border-l-4 border-red-500 p-4 rounded shadow-lg">
        <div class="flex">
